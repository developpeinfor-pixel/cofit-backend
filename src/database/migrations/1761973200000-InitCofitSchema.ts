...
export class InitCofitSchema1761973200000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM pg_constraint WHERE conname = 'fk_matches_competition'
        ) THEN
          ALTER TABLE matches
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM pg_constraint WHERE conname = 'fk_standings_competition'
        ) THEN
          ALTER TABLE standings
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM pg_constraint WHERE conname = 'fk_standings_team'
        ) THEN
          ALTER TABLE standings
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM pg_constraint WHERE conname = 'fk_videos_match'
        ) THEN
          ALTER TABLE videos
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM pg_constraint WHERE conname = 'fk_supporter_cards_user'
        ) THEN
          ALTER TABLE supporter_cards
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM pg_constraint WHERE conname = 'fk_tickets_user'
        ) THEN
          ALTER TABLE tickets
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM pg_constraint WHERE conname = 'fk_payments_user'
        ) THEN
          ALTER TABLE payments
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM pg_constraint WHERE conname = 'fk_payments_ticket'
        ) THEN
          ALTER TABLE payments
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM pg_constraint WHERE conname = 'fk_payments_supporter_card'
        ) THEN
          ALTER TABLE payments
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM pg_constraint WHERE conname = 'fk_device_tokens_user'
        ) THEN
          ALTER TABLE device_tokens
